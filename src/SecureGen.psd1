@{
    ...
    Copyright         = '(c) 2026'
    Description       = 'Module PowerShell moderne pour générer des mots de passe, passphrases et clés sécurisées. Compatible PowerShell 5 et 7, avec clipboard cross-platform et ergonomie soignée.'
